...
object CasEncDecQrProcessor {
    ...
    private fun fromBase64Encoding(base64EncodeStr: String): String {
        return Base64.decode(base64EncodeStr.encodeToByteArray(), Base64.NO_PADDING).decodeToString()
                .trim()
    }
    ...
    fun getEncryptedEncodedPayloadForScannedDeviceWithCompLoc(locId: Int, compId: Int, timeStamp: String): String {
